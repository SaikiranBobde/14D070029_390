...
1.Software for the INTERSTELLAR TIC-TAC-TOE is quite simple and requires the user to have ubuntu or windows installed in the machine. 
...
Once you are done with this procedure of installing simplecpp and all you can proceed to run the software.
